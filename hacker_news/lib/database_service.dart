...
class DatabaseService {
  ...
  Future<Database> _openDatabase() async {
    if (kIsWeb) {
      // Use web database factory for web platform
      final database = await databaseFactoryWeb.openDatabase(_dbName);
      return database;
    } else {
      // Use IO database factory for mobile/desktop platforms
